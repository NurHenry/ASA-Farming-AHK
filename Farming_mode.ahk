...
Gui, Add, Text, x+10 y+70 w200 h80 cWhite, Press F9 to toggle Left Click Farming`nPress F10 to toggle Spacebar Farming`nPress F8 to toggle Right Click Spamming`nPress F7 to toggle Auto Feeding`nPress F6 to run Anky empty
Gui, Add, Button, x+10 y+150 w100 h30 gExitScript, Exit
Gui, Show, x0 y0
...
F6::
    ...
    MouseClick, left, A_ScreenWidth * 0.656250, A_ScreenHeight * 0.182407
    Sleep, 1000

    SendInput, stone
    MouseClick, left, A_ScreenWidth * 0.742188, A_ScreenHeight * 0.186111
    Sleep, 1000

    MouseClick, left, A_ScreenWidth * 0.438021, A_ScreenHeight * 0.675926
    SendInput, {Esc}
